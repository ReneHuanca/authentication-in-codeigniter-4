    ...
    <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
        <div class="card z-index-0">
            ...
            <div class="card-body">
                ...
                <?= form_open(route_to('register.store'), ['role' => 'form']) ?>
                <div class="mb-3">
                    <input type="text" name="name" class="form-control" placeholder="Name" aria-label="Name" value="<?= set_value('name') ?>">
                    <?php if (isset($errors)) : ?>
                        <div class="text-sm text-danger"><?= $errors->hasError('name') ? $errors->getError('name') : '' ?></div>
                    <?php endif; ?>
                </div>
                <div class="mb-3">
                    <input type="email" name="email" class="form-control" placeholder="Email" aria-label="Email" value="<?= set_value('email') ?>">
                    <?php if (isset($errors)) : ?>
                        <div class="text-sm text-danger"><?= $errors->hasError('email') ? $errors->getError('email') : '' ?></div>
                    <?php endif; ?>
                </div>
                <div class="mb-3">
                    <input type="password" name="password" class="form-control" placeholder="Password" aria-label="Password">
                    <?php if (isset($errors)) : ?>
                        <div class="text-sm text-danger"><?= $errors->hasError('password') ? $errors->getError('password') : '' ?></div>
                    <?php endif; ?>
                </div>
                <div class="mb-3">
                    <input type="password" name="confirmpassword" class="form-control" placeholder="Confirm password" aria-label="confirm Password">
                    <?php if (isset($errors)) : ?>
                        <div class="text-sm text-danger"><?= $errors->hasError('confirmpassoword') ? $errors->getError('confirmpassword') : '' ?></div>
                    <?php endif; ?>
                </div>
